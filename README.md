...
```shell
git clone https://github.com/MrCiny/E-Veikals-MUI.git
```
...
Aplikāciju var arī apskatīt CodeSandbox vidē, noklikšķinot uz saites https://codesandbox.io/s/github/MrCiny/E-Veikals-MUI.
